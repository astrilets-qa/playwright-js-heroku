...
Automated UI test framework built with **Playwright (JavaScript)** to demonstrate **scalable test architecture**, **maintainable automation design**, and **CI-ready execution**.

The framework uses the public demo application  
👉 https://the-internet.herokuapp.com/login  
to showcase real-world testing patterns without artificial mocks.
